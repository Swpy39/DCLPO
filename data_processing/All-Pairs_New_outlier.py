...
if __name__ == "__main__":
    ...
    embedding_model_path = '/data/models/BAAI/bge-m3'
    ...
    # 使用百分位数代替原来的3倍标准差方法
    lower_bound = np.percentile(JS_array, 3)  # 5%百分位数
    upper_bound = np.percentile(JS_array, 97)  # 95%百分位数

    print("5th percentile (lower bound): ", lower_bound)
    print("95th percentile (upper_bound): ", upper_bound)
    ...
    for item in prompt_data:
        ...
        for pair in pairs:
            ...
            if difficulty_score <= lower_bound or difficulty_score >= upper_bound:
                difficulty_score = -10
    ...
    # 可选保存
    with open("../dataset/All-Pairs/ultrafeedback(w1={},w2={},w3={}).json".format(w1,w2,w3), 'w',encoding='utf-8') as f:
        json.dump(results, f, ensure_ascii=False, indent=4)
    print("结果已保存至../dataset/All-Pairs/ultrafeedback(w1={},w2={},w3={}).json".format(w1,w2,w3))
    ...
    with open("../dataset/All-Pairs/ultrafeedback_score_list(w1={},w2={},w3={}).json".format(w1,w2,w3), 'w',encoding='utf-8') as f:
