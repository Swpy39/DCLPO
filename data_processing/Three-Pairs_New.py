...
if __name__ == "__main__":
    ...
    embedding_model_path = '/data/models/BAAI/bge-m3'  ## m3e-base(768维）//////BAAI/bge-m3（1024维） //////bce-embedding-base_v1（768维）
    ...
    # 可选保存
    with open("../dataset/Three-Pairs/ultrafeedback(w1={},w2={},w3={}).json".format(w1,w2,w3), 'w',encoding='utf-8') as f:
        json.dump(results, f, ensure_ascii=False, indent=4)
    print("结果已保存至../dataset/Three-Pairs/ultrafeedback(w1={},w2={},w3={}).json".format(w1,w2,w3))
    ...
    with open("../dataset/Three-Pairs/ultrafeedback_score_list(w1={},w2={},w3={}).json".format(w1,w2,w3), 'w',encoding='utf-8') as f:
