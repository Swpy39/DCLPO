...
def curri_dpo(split: str, silent: bool = False, cache_dir: str = None, alpha: float = 0.0) -> Dict[str, Dict]:
    print(f"Loading ultrafeedback_curriculum_dpo_pairs {split} dataset...")
    data_file = {
        "train": "./dataset/Three-pairs_PC-gpt_PPD-JS_dataset(α={},α_gt_0).json".format(alpha),
        "test": "./dataset/Three-pairs_PC-gpt_PPD-JS_dataset(α={},α_gt_0).json".format(alpha)
    }.get(split)
...
def get_batch_iterator(names: List[str],
    ...
    file_path = './dataset/Three-pairs_PC-gpt_PPD-JS_score_list(α={},α_gt_0).json'.format(alpha)
