...
def get_batch_iterator(names: List[str],
    ...
    file_path = './dataset/{}/HelpSteer_score_list(w1={},w2={}).json'.format(config.curriculum_type, config.w1, config.w2)  # './dataset/{}/score_list(gama=1,T=0.07,eta=0.1,w1=0.4,w2=0.4,w3=0.1).json'.format(config.curriculum_type)
